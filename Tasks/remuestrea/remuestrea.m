function remuestrea(campaign,periodoremuestreo,numdescarga,numsignal)

% Ejemplo de llamada de la función en matlab:
%        remuestrea('C15a',0.001,65988,6)
...
save(savepath,"d_r","numdescarga","numsignal","namesignal","signal")